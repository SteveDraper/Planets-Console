...
| `homeworld_locator.evidence_promotion_threshold` | integer | `2` | Unused for promotion (SB-only hard definite). Kept for YAML compat until replaced by soft-evidence config. |
