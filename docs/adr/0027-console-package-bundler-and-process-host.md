...
Unsigned v1 is acceptable. No Electron/Tauri SPA window. No tray in v1. **Installer wrapper**s and CI are [ADR 0028](0028-console-package-ci-and-installer-wrappers.md). **Listen-then-open** and reopen copy are [ADR 0029](0029-console-package-identity-and-install-over.md); the **process host** must still handle Mac reopen without creating a native window.
