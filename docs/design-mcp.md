...
**Status:** Accepted v1 design (shipped: package, `/mcp` mount, login, five **MCP shell tool**s, nine **MCP named gameplay tool**s wrapping Core concepts, six **MCP TurnInfo fallback** tools, three **MCP export query hatch** tools)  
