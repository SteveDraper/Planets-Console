...
type AnalyticTableGridProps = {
  isPending: boolean
  error: unknown
  data: Pick<TableDataResponse, 'columns' | 'rows'> | null | undefined
}

/** Presentational columns/rows table for generic and scores-fallback table views. */
export function AnalyticTableGrid({ isPending, error, data }: AnalyticTableGridProps) {
