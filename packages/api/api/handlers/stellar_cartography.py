...
def turn_summary(
    ...
    """Return lightweight cartography facts for the turn."""
    turn = svc.get_turn_info(game_id, perspective, turn_number)
    payload = stellar_cartography_turn_summary(turn)
    return StellarCartographyTurnSummaryResponse.model_validate(payload)
