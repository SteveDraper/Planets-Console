...
_SLOW_TEST_NAMES = frozenset(
    {
        ...
        "test_accelerated_first_reliable_refines_segment_option_sets_for_root",
        "test_accelerated_first_reliable_refines_without_scores_diagnostics",
        "test_accelerated_window_refine_when_intermediate_scoreboard_turn_missing",
        ...
        "test_functional_backfill_resolves_host_turn_targets_without_diagnostics",
        "test_functional_target_for_host_turn_uses_typed_fields",
        "test_functional_target_residual_maps_to_complete_with_leftover",
        "test_functional_target_time_limited_maps_to_stopped_search_status",
        "test_get_row_upgrades_legacy_v1_split_row_with_write_back",
        "test_get_scores_row_inference_emits_applied_fleet_torp_input_status",
        "test_host2_manifest_runs_tier1_without_coverage_gate",
        "test_host_turn_functional_target_persistence_round_trip",
        "test_host_turn_functional_target_wire_round_trip",
        "test_inference_diagnostics_include_policy_ladder_fields",
        "test_inference_overlay_changes_diagnostics_vs_empty_overlay",
        "test_legacy_camel_case_persistence_dict_still_loads",
        "test_legacy_v1_upgrade_enables_functional_backfill_without_diagnostics",
        ...
        "test_p2_unreliable_turn2_backfills_host_turn1_freighter_only",
        ...
        "test_persisted_inference_row_host_turn_targets_round_trip",
        "test_put_row_promotes_accelerated_segments_before_dropping_diagnostics",
        ...
        "test_upgrade_persisted_inference_row_copies_accelerated_segments",
    }
)
